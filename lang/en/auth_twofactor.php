...
$string['enter_verification'] = 'A verification code was sent to your {$a}, please enter the code here to continue.';
...
$string['auth_twofactor_timespan'] = 'Time Span in seconds';
$string['auth_twofactor_timespan_desc'] = 'A verification code is only valid for X amount of time.';
...
$string['validduringtimespan'] = 'The verification code is only valid for {$a}.';
$string['auth_twofactor_method'] = 'Method';
$string['auth_twofactor_method_desc'] = 'Select how the verification code should be delivered.';
$string['verificationcode'] = 'Your verification code';
$string['messagebirdnote'] = 'If your method is SMS (MessageBird), you must sign up with MessageBird and add your Live API Key.';
$string['messagebirdnote'] = 'Hello,<br/><br/> Your verification code is: <strong>{$a}</strong><br/><br/>Best regards';
$string['methodlist'] = 'Email or SMS (MessageBird)';
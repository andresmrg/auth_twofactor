 ...
 */
namespace auth_twofactor\event;
...
class message_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmessage_sent', 'auth_twofactor');
    }

    public function get_description() {
        return "The user with id {$this->userid} received a verification message with the code {$this->objectid}.";
    }
    ...
    public static function get_legacy_message_sent() {
